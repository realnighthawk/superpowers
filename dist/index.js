...
import { loadAgentConfig, updateAgentConfig } from "./src/agent-config.js";
...
export default definePluginEntry({
    ...
    register(api) {
        ...
        api.registerTool({
            ...
            description: "Read the steward user profile from assistant workspace (user-profile.json). assistant-only; other agents do not use this.",
        ...
        api.registerTool({
            ...
            description: "Merge fields into user-profile.json in assistant workspace. Nested objects are deep-merged.",
            parameters: Type.Object({
        ...
        api.registerTool({
            ...
            description: "Read the agent config (name, personality) for a given agent. Used by agents to load their user-defined identity on startup.",
            parameters: Type.Object({
        ...
        api.registerTool({
            ...
            description: "Update the agent config (name, personality) for a given agent. Used during first-run bootstrap to store user-defined identity.",
            parameters: Type.Object({
                agentId: Type.String({ description: "Agent ID, e.g. assistant" }),
                patch: Type.Object({
