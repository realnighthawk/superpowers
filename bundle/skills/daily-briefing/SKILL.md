---
name: daily-briefing
description: Generate a concise morning briefing. Called by the assistant at 7am. Returns bullet-point markdown for Discord.
---
...
- Calendar events for today (provided by the assistant in spawn task)
